...
public class Precipitation extends Attribute {
    ...
    public Entry<Term, Membership> high() {
        ...
        Term term = new Term("z du¿ymi opadami", scope, "z du¿ymi opadami", "z du¿ymi opadami");
    ...
    public Entry<Term, Membership> medium() {
        ...
        Term term = new Term("z œrednimi opadami", scope, "z œrednimi opadami", "z œrednimi opadami");
